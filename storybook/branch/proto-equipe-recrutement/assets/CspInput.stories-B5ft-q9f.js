import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{_t as t,l as n,tt as r}from"./iframe-C0OAurLG.js";import{n as i,t as a}from"./CspInput-C4uxB2p3.js";var o,s,c,l,u,d,f,p,m;function h(){return(h=e((()=>{n(),i(),o={title:`Éléments/Génériques/CspInput`,component:a,tags:[`autodocs`],parameters:{controls:{include:[`modelValue`,`type`,`placeholder`,`size`,`disabled`,`error`,`errorMessage`,`id`,`name`,`label`]},docs:{description:{component:`Champ de saisie de texte.`}}},argTypes:{modelValue:{control:{type:`text`},description:`Valeur actuelle (v-model).`,table:{type:{summary:`string`}}},type:{control:{type:`radio`},options:[`text`,`email`,`password`,`search`,`tel`,`url`,`number`],description:`Type d'entrée natif.`,table:{type:{summary:`text | email | password | search | tel | url | number`},defaultValue:{summary:`text`}}},placeholder:{control:{type:`text`},description:`Texte d'espace réservé (placeholder).`,table:{type:{summary:`string`}}},size:{control:{type:`radio`},options:[`sm`,`md`,`lg`],description:`Taille de l'entrée.`,table:{type:{summary:`sm | md | lg`},defaultValue:{summary:`md`}}},disabled:{control:{type:`boolean`},description:`Désactive l'entrée.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},error:{control:{type:`boolean`},description:`Affiche le champ en état d'erreur.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},errorMessage:{control:{type:`text`},description:"Message d'erreur optionnel, affiché lorsque `error` est actif.",table:{type:{summary:`string`}}},id:{control:{type:`text`},description:`ID optionnel pour l'association du label.`,table:{type:{summary:`string`}}},name:{control:{type:`text`},description:`Nom optionnel pour la soumission du formulaire.`,table:{type:{summary:`string`}}},class:{control:!1,table:{disable:!0}},style:{control:!1,table:{disable:!0}},key:{control:!1,table:{disable:!0}},ref:{control:!1,table:{disable:!0}},ref_for:{control:!1,table:{disable:!0}},ref_key:{control:!1,table:{disable:!0}}},args:{modelValue:``,type:`text`,placeholder:`Saisir un texte`,size:`md`,disabled:!1,id:`base-input-story`,name:`base-input`,label:`Libellé`},render:e=>({components:{CspInput:a},setup(){let n=t(e.modelValue??``);r(()=>e.modelValue,e=>{n.value=e??``});function i(e){n.value=e}return{args:e,value:n,handleUpdate:i}},template:`
    ...
    `})},p={args:{label:`Libellé input`,error:!0,errorMessage:`Ce champ est obligatoire.`,modelValue:``},render:e=>({components:{CspInput:a},setup(){let n=t(e.modelValue??``);return r(()=>e.modelValue,e=>{n.value=e??``}),{args:e,value:n}},template:`
      <div class="w-96">
        <CspInput
          v-bind="args"
          :model-value="value"
