import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,ft as n,ut as r,y as i}from"./iframe-CrUhtth-.js";import{n as a,t as o}from"./CspTag-C1OqmaOa.js";import{n as s,t as c}from"./CspPagination-DvMXP57S.js";import{n as l,t as u}from"./CspDataTable-4SjuvPd4.js";function d(){let e=n(new Set),t=i(()=>e.value.size);function r(t){let n=new Set(e.value);n.has(t)?n.delete(t):n.add(t),e.value=n}function a(t){let n=t.length>0&&t.every(t=>e.value.has(t)),r=new Set(e.value);n?t.forEach(e=>r.delete(e)):t.forEach(e=>r.add(e)),e.value=r}return{count:t,selectedIds:e,toggle:r,toggleVisible:a}}function f(e){return()=>({components:{CspDataTable:u,CspTag:o},setup(){return{columns:h,demos:r(e.map(e=>{let t=d();return{...e,count:t.count,selectedIds:t.selectedIds,onToggleRow:e=>t.toggle(e),onToggleAll:e=>t.toggleVisible(e)}}))}},template:`
