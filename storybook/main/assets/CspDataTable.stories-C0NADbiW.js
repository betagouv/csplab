import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{b as t,c as n,ht as r,pt as i}from"./iframe-BnAB8whF.js";import{n as a,t as o}from"./CspTag-C9-We3jA.js";import{n as s,t as c}from"./CspPagination-DkB7isxO.js";import{n as l,t as u}from"./CspDataTable-zGsYyTJF.js";function d(){let e=r(new Set),n=t(()=>e.value.size);function i(t){let n=new Set(e.value);n.has(t)?n.delete(t):n.add(t),e.value=n}function a(t){let n=t.length>0&&t.every(t=>e.value.has(t)),r=new Set(e.value);n?t.forEach(e=>r.delete(e)):t.forEach(e=>r.add(e)),e.value=r}return{count:n,selectedIds:e,toggle:i,toggleVisible:a}}function f(e){return()=>({components:{CspDataTable:u,CspTag:o},setup(){return{columns:h,demos:i(e.map(e=>{let t=d();return{...e,count:t.count,selectedIds:t.selectedIds,onToggleRow:e=>t.toggle(e),onToggleAll:e=>t.toggleVisible(e)}}))}},template:`
    ...
    `})},_={name:`Par défaut`},v={name:`Tailles`,render:()=>({components:{CspDataTable:u,CspTag:o},setup(){return{columns:h,rows:m,sizes:[`sm`,`md`,`lg`]}},template:`
      <div class="grid max-w-6xl gap-6">
        <section
          v-for="s in sizes"
          :key="s"
    ...
    `}),parameters:{controls:{disable:!0},docs:{description:{story:"Active une ligne (navigation ou ouverture d’un drawer) soit au clic sur toute la ligne (`row`), soit au clic sur une cible précise rendue dans un slot de cellule via le helper `activate` (`cell`). En mode `cell`, le déclencheur reste un vrai bouton focusable au clavier."}}}},C=[`DefaultDemo`,`Sizes`,`Overflow`,`StateVariants`,`ActivationModes`],_.parameters={..._.parameters,docs:{..._.parameters?.docs,source:{originalSource:`{
  name: 'Par défaut'
...
}`,...S.parameters?.docs?.source}}}})))()}w();export{S as ActivationModes,_ as DefaultDemo,b as Overflow,v as Sizes,x as StateVariants,C as __namedExportsOrder,g as default};