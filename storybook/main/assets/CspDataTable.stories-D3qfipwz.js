import{i as e}from"./preload-helper-Ct_ODC0V.js";import{D as t,R as n,jt as r,kt as i}from"./iframe-CnXcE5s9.js";import{n as a,t as o}from"./CspPagination-ClRhKmWi.js";import{n as s,t as c}from"./CspTag-CtRgm74i.js";import{n as l,t as u}from"./CspDataTable-Bet424o6.js";function d(){let e=r(new Set),t=n(()=>e.value.size);function i(t){let n=new Set(e.value);n.has(t)?n.delete(t):n.add(t),e.value=n}function a(t){let n=t.length>0&&t.every(t=>e.value.has(t)),r=new Set(e.value);n?t.forEach(e=>r.delete(e)):t.forEach(e=>r.add(e)),e.value=r}return{count:t,selectedIds:e,toggle:i,toggleVisible:a}}function f(e){return()=>({components:{CspDataTable:u,CspTag:c},setup(){return{columns:h,demos:i(e.map(e=>{let t=d();return{...e,count:t.count,selectedIds:t.selectedIds,onToggleRow:e=>t.toggle(e),onToggleAll:e=>t.toggleVisible(e)}}))}},template:`
