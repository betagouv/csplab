import{C as n}from"./CspButton-DQbrDlMl.js";import"./vue.esm-bundler-aFrwtEYQ.js";import"./CspIcon-RLmKRc9J.js";const N={title:"Éléments/Génériques/CspButton",component:n,tags:["autodocs"],parameters:{controls:{include:["variant","size","isIconLeft","label","icon","as","asChild"]},docs:{description:{component:"Bouton générique. Doit avoir un `label`, une `icon`, ou les deux."}}},argTypes:{variant:{control:{type:"radio"},options:["primary","secondary","tertiary","tertiary-no-outline"],description:"Style visuel.",table:{type:{summary:"primary | secondary | tertiary | tertiary-no-outline"},defaultValue:{summary:"primary"}}},size:{control:{type:"radio"},options:["sm","md","lg"],description:"Taille du bouton.",table:{type:{summary:"sm | md | lg"},defaultValue:{summary:"md"}}},isIconLeft:{control:{type:"boolean"},description:"Afficher l'icône avant le libellé.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},label:{control:{type:"text"},description:"Texte du bouton. Requis si `icon` est absent.",table:{type:{summary:"string"}}},icon:{control:{type:"text"},description:"Nom Iconify. Requis si `label` est absent.",table:{type:{summary:"string"}}},as:{control:{type:"text"},description:"Élément ou composant rendu.",table:{type:{summary:"string | Component"},defaultValue:{summary:"button"}}},asChild:{control:{type:"boolean"},description:"Rendre l'enfant comme élément racine.",table:{type:{summary:"boolean"},defaultValue:{summary:"false"}}},class:{control:!1,table:{disable:!0}},style:{control:!1,table:{disable:!0}},key:{control:!1,table:{disable:!0}},ref:{control:!1,table:{disable:!0}},ref_for:{control:!1,table:{disable:!0}},ref_key:{control:!1,table:{disable:!0}}},args:{variant:"primary",size:"md",isIconLeft:!1,label:"Libellé du bouton",asChild:!1},render:e=>({components:{CspButton:n},setup(){return{args:e}},template:'<CspButton v-bind="args" />'})},w=["primary","secondary","tertiary","tertiary-no-outline"],V=["sm","md","lg"],s={args:{label:"Button label"}},a={render:e=>({components:{CspButton:n},setup(){return{variants:w,args:e}},template:`
    ...
    `})},t={render:e=>({components:{CspButton:n},setup(){return{sizes:V,args:e}},template:`
      <div class="flex flex-row gap-12">
        <div
          v-for="s in sizes"
          :key="s"
...
}`,...(c=(p=s.parameters)==null?void 0:p.docs)==null?void 0:c.source}}};var d,u,v;a.parameters={...a.parameters,docs:{...(d=a.parameters)==null?void 0:d.docs,source:{originalSource:`{
  render: args => ({
    components: {
      CspButton
    },
...
}`,...(v=(u=a.parameters)==null?void 0:u.docs)==null?void 0:v.source}}};var m,b,f;t.parameters={...t.parameters,docs:{...(m=t.parameters)==null?void 0:m.docs,source:{originalSource:`{
  render: args => ({
    components: {
      CspButton
    },
...
}`,...(f=(b=t.parameters)==null?void 0:b.docs)==null?void 0:f.source}}};var y,g,x;r.parameters={...r.parameters,docs:{...(y=r.parameters)==null?void 0:y.docs,source:{originalSource:`{
  render: args => ({
    components: {
      CspButton
    },
...
}`,...(L=(I=i.parameters)==null?void 0:I.docs)==null?void 0:L.source}}};const R=["Default","Variants","Sizes","Icons","States","AsLink"];export{i as AsLink,s as Default,r as Icons,t as Sizes,o as States,a as Variants,R as __namedExportsOrder,N as default};
