import{n as e}from"./rolldown-runtime-DkW27tQK.js";import{c as t,ft as n,mt as r,y as i}from"./iframe-DoYE-1Jl.js";import{n as a,t as o}from"./CspTag-DacbzMmI.js";import{n as s,t as c}from"./CspPagination-CkSaYcJJ.js";import{n as l,t as u}from"./CspDataTable-rQJHxSF7.js";function d(){let e=r(new Set),t=i(()=>e.value.size);function n(t){let n=new Set(e.value);n.has(t)?n.delete(t):n.add(t),e.value=n}function a(t){let n=t.length>0&&t.every(t=>e.value.has(t)),r=new Set(e.value);n?t.forEach(e=>r.delete(e)):t.forEach(e=>r.add(e)),e.value=r}return{count:t,selectedIds:e,toggle:n,toggleVisible:a}}function f(e){return()=>({components:{CspDataTable:u,CspTag:o},setup(){return{columns:h,demos:n(e.map(e=>{let t=d();return{...e,count:t.count,selectedIds:t.selectedIds,onToggleRow:e=>t.toggle(e),onToggleAll:e=>t.toggleVisible(e)}}))}},template:`
