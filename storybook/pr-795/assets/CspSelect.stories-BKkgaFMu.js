import{i as e}from"./preload-helper-CnUkjUDP.js";import{B as t,C as n,Ft as r,I as i,J as a,L as o,Mt as s,R as c,Rt as l,Tt as u,V as d,ct as f,dt as p,j as m,lt as h,mt as g,rt as _,tt as v,z as y}from"./iframe-DYT3_zZi.js";import{n as b,t as x}from"./_plugin-vue_export-helper-BbC-fNz1.js";import{B as S,H as C,I as w,J as T,K as E,M as D,P as O,Q as k,R as A,W as j,X as M,t as N}from"./dist-BTD11G2y.js";import{n as P,t as F}from"./CspIcon-BiCNJf0D.js";var I,L,R,z=e((()=>{n(),N(),P(),I=[`for`],L={key:1,class:`csp-select-group__error`,role:`alert`},R=d({__name:`CspSelect`,props:a({options:{},placeholder:{default:`Sélectionner…`},size:{default:`md`},disabled:{type:Boolean,default:!1},error:{type:Boolean,default:!1},errorMessage:{},id:{default:()=>f()},label:{}},{modelValue:{},modelModifiers:{}}),emits:[`update:modelValue`],setup(e){let n=h(e,`modelValue`);return(a,u)=>(v(),c(`div`,{class:r([`csp-select-group`,{"csp-select-group--error":e.error}])},[e.label?(v(),c(`label`,{key:0,class:`csp-select-group__label`,for:e.id},l(e.label),9,I)):o(``,!0),t(s(k),{modelValue:n.value,"onUpdate:modelValue":u[0]||=e=>n.value=e,disabled:e.disabled},{default:g(()=>[t(s(w),{id:e.id,class:r([`csp-select`,[`csp-select--${e.size}`,{"csp-select--error":e.error}]]),"aria-invalid":e.error||void 0},{default:g(()=>[t(s(O),{placeholder:e.placeholder},null,8,[`placeholder`]),t(F,{class:`csp-select__chevron`,name:`ri:arrow-down-s-line`})]),_:1},8,[`id`,`class`,`aria-invalid`]),t(s(C),null,{default:g(()=>[t(s(M),{class:`csp-select-content`,position:`popper`,"side-offset":4},{default:g(()=>[t(s(A),{class:`csp-select-content__scroll-btn`},{default:g(()=>[t(F,{name:`ri:arrow-up-s-line`})]),_:1}),t(s(D),{class:`csp-select-content__viewport`},{default:g(()=>[(v(!0),c(m,null,_(e.options,e=>(v(),i(s(T),{key:e.value,class:`csp-select-content__item`,value:e.value,disabled:e.disabled},{default:g(()=>[t(s(j),null,{default:g(()=>[y(l(e.label),1)]),_:2},1024),t(s(E),{class:`csp-select-content__item-indicator`},{default:g(()=>[t(F,{name:`ri:check-line`})]),_:1})]),_:2},1032,[`value`,`disabled`]))),128))]),_:1}),t(s(S),{class:`csp-select-content__scroll-btn`},{default:g(()=>[t(F,{name:`ri:arrow-down-s-line`})]),_:1})]),_:1})]),_:1})]),_:1},8,[`modelValue`,`disabled`]),e.error&&e.errorMessage?(v(),c(`p`,L,[t(F,{name:`ri:error-warning-fill`,size:14}),y(` `+l(e.errorMessage),1)])):o(``,!0)],2))}})})),B=e((()=>{})),V,H=e((()=>{z(),z(),B(),b(),V=x(R,[[`__scopeId`,`data-v-3d6fe604`]]),R.__docgenInfo=Object.assign({displayName:R.name??R.__name},{exportName:`default`,displayName:`CspSelect`,type:1,props:[{name:`options`,global:!1,description:``,tags:[],required:!0,type:`{ value: string; label: string; disabled?: boolean; }[]`,declarations:[],schema:{kind:`array`,type:`{ value: string; label: string; disabled?: boolean; }[]`}},{name:`placeholder`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`,default:`"S\\u00E9lectionner\\u2026"`},{name:`size`,global:!1,description:``,tags:[],required:!1,type:`"md" | "sm" | "lg"`,declarations:[],schema:{kind:`enum`,type:`"md" | "sm" | "lg"`,schema:[`"md"`,`"sm"`,`"lg"`]},default:`"md"`},{name:`disabled`,global:!1,description:``,tags:[],required:!1,type:`boolean`,declarations:[],schema:{kind:`enum`,type:`boolean`,schema:[`false`,`true`]},default:`false`},{name:`error`,global:!1,description:``,tags:[],required:!1,type:`boolean`,declarations:[],schema:{kind:`enum`,type:`boolean`,schema:[`false`,`true`]},default:`false`},{name:`errorMessage`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`},{name:`id`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`,default:`useId()`},{name:`label`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`},{name:`modelValue`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`},{name:`key`,global:!1,description:``,tags:[],required:!1,type:`PropertyKey`,declarations:[],schema:{kind:`enum`,type:`PropertyKey`,schema:[`string`,`number`,`symbol`]}},{name:`ref`,global:!1,description:``,tags:[],required:!1,type:`VNodeRef`,declarations:[],schema:{kind:`enum`,type:`VNodeRef`,schema:[`string`,`Ref<any, any>`,{kind:`event`,type:`(ref: Element | ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}, {}, string, {}, {}, {}, string, ComponentProvideOptions>, ... 4 more ..., any>, refs: Record<...>): void`}]}},{name:`ref_for`,global:!1,description:``,tags:[],required:!1,type:`boolean`,declarations:[],schema:{kind:`enum`,type:`boolean`,schema:[`false`,`true`]}},{name:`ref_key`,global:!1,description:``,tags:[],required:!1,type:`string`,declarations:[],schema:`string`},{name:`class`,global:!1,description:``,tags:[],required:!1,type:`unknown`,declarations:[],schema:`unknown`},{name:`style`,global:!1,description:``,tags:[],required:!1,type:`unknown`,declarations:[],schema:`unknown`}],events:[{name:`update:modelValue`,description:``,tags:[],type:`[value: string]`,signature:`(event: "update:modelValue", value: string): void`,declarations:[],schema:[`string`]}],slots:[],exposed:[{name:`error`,type:`boolean`,description:``,declarations:[],schema:{kind:`enum`,type:`boolean`,schema:[`false`,`true`]}},{name:`disabled`,type:`boolean`,description:``,declarations:[],schema:{kind:`enum`,type:`boolean`,schema:[`false`,`true`]}},{name:`size`,type:`"md" | "sm" | "lg"`,description:``,declarations:[],schema:{kind:`enum`,type:`"md" | "sm" | "lg"`,schema:[`"md"`,`"sm"`,`"lg"`]}},{name:`placeholder`,type:`string`,description:``,declarations:[],schema:`string`},{name:`id`,type:`string`,description:``,declarations:[],schema:`string`},{name:`label`,type:`string`,description:``,declarations:[],schema:`string`},{name:`modelValue`,type:`string`,description:``,declarations:[],schema:`string`},{name:`options`,type:`{ value: string; label: string; disabled?: boolean; }[]`,description:``,declarations:[],schema:{kind:`array`,type:`{ value: string; label: string; disabled?: boolean; }[]`}},{name:`errorMessage`,type:`string`,description:``,declarations:[],schema:`string`}],sourceFiles:`/home/runner/work/csplab/csplab/src/web/presentation/frontend/src/components/base/CspSelect/CspSelect.vue`})})),U,W,G,K,q,J,Y;e((()=>{n(),H(),U=[{value:`option-1`,label:`Option 1`},{value:`option-2`,label:`Option 2`},{value:`option-3`,label:`Option 3`},{value:`option-4`,label:`Option 4`},{value:`option-5`,label:`Option 5`,disabled:!0}],W={title:`Éléments/Génériques/CspSelect`,component:V,tags:[`autodocs`],parameters:{controls:{include:[`modelValue`,`options`,`placeholder`,`size`,`disabled`,`error`,`errorMessage`,`label`]},docs:{description:{component:"Sélecteur générique construit sur la primitive `reka-ui` Select. Gère le focus, la navigation clavier et l'accessibilité. Contrôlé via `v-model`."}}},argTypes:{modelValue:{control:{type:`text`},description:`Valeur sélectionnée (v-model).`,table:{type:{summary:`string`}}},options:{control:!1,description:"Liste des options. Chaque option a une `value`, un `label` et un `disabled` optionnel.",table:{type:{summary:`CspSelectOption[]`}}},placeholder:{control:{type:`text`},description:`Texte affiché quand aucune valeur n'est sélectionnée.`,table:{type:{summary:`string`},defaultValue:{summary:`Sélectionner…`}}},size:{control:{type:`radio`},options:[`sm`,`md`,`lg`],description:`Taille du déclencheur.`,table:{type:{summary:`sm | md | lg`},defaultValue:{summary:`md`}}},disabled:{control:{type:`boolean`},description:`Désactive le sélecteur.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},error:{control:{type:`boolean`},description:`Affiche l'état d'erreur.`,table:{type:{summary:`boolean`},defaultValue:{summary:`false`}}},errorMessage:{control:{type:`text`},description:"Message d'erreur affiché sous le sélecteur si `error` est vrai.",table:{type:{summary:`string`}}},label:{control:{type:`text`},description:`Libellé visible au-dessus du sélecteur.`,table:{type:{summary:`string`}}},class:{control:!1,table:{disable:!0}},style:{control:!1,table:{disable:!0}},key:{control:!1,table:{disable:!0}},ref:{control:!1,table:{disable:!0}},ref_for:{control:!1,table:{disable:!0}},ref_key:{control:!1,table:{disable:!0}}},args:{options:U,placeholder:`Sélectionner…`,size:`md`,disabled:!1,error:!1,label:`Choisir une option`},render:e=>({components:{CspSelect:V},setup(){let t=u(e.modelValue??``);return p(()=>e.modelValue,e=>{t.value=e??``}),{args:e,value:t}},template:`
    ...
    `}),parameters:{controls:{disable:!0}}},J={name:`États`,render:()=>({components:{CspSelect:V},setup(){return{options:U}},template:`
      <div class="flex flex-col gap-6 max-w-xs">
        <CspSelect label="Normal" :options="options" placeholder="Sélectionner…" />
        <CspSelect label="Valeur sélectionnée" :options="options" model-value="option-1" />
        <CspSelect label="Désactivé" :options="options" placeholder="Désactivé" :disabled="true" />
        <CspSelect
          label="Erreur"
          :options="options"
          :error="true"
