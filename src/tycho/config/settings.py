...
env = environ.Env(
    ...
    TYCHO_TALENTSOFT_CLIENT_ID=(str, "talent-client-id"),
    TYCHO_TALENTSOFT_CLIENT_SECRET=(str, "talent-client-secret"),
    TYCHO_TALENTSOFT_BASE_URL=(str, "https://talentsoft.test.com"),
)
env.prefix = "TYCHO_"
