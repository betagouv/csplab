...
def test_execute_returns_zero_when_no_documents(documents_usecase):
...
def test_get_by_type_returns_documents_of_correct_type_only(
    documents_repository, corps_documents, concours_documents
):
    ...
    documents_repository.upsert_batch(concours_documents, DocumentType.CONCOURS.value)
...
def test_upsert_batch_creates_new_document(documents_repository, corps_document):
...
def test_upsert_batch_returns_correct_counts(documents_repository, corps_documents):
