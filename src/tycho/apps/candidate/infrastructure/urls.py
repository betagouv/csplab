...
urlpatterns = [
    ...
    path("cv/<uuid:cv_id>/confirmation/", CVConfirmationView.as_view(), name="cv_confirmation"),
    path("cv/<uuid:cv_id>/resultats/", ResultatsAnalyseView.as_view(), name="cv_results"),
    path("opportunite/<int:pk>/", OpportuniteDetailView.as_view(), name="opportunite_detail"),
]
