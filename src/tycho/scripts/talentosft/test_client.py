...
from apps.ingestion.infrastructure.adapters.external.talentsoft.client import (
    TalentSoftHttpClient,
)
...
def main() -> None:
    ...
    client = TalentSoftHttpClient(
        config=config, logger_service=DummyLoggerService(), timeout=30
    )
