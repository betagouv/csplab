...
class TestCandidatureDocumentsView:
    ...
    def test_authorized_agent_lists_the_documents(
        ...
        assert results[0]["document_id"] == str(document.pk)
        assert results[0]["type_document"] == document.type_document
        ...
        assert results[0]["depose_par_id"] == str(document.depose_par_id)
        assert results[0]["depose_par_nom"] == document.depose_par.last_name
        assert results[0]["depose_par_prenom"] == document.depose_par.first_name
