...
export const AvecAction: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: 'L\'option d\'action apparaît en fin de liste, séparée des résultats. Elle n\'est jamais pré-surlignée et émet `action` au lieu de sélectionner une valeur.',
      },
    },
  },
}
