...
export const RECRUTEMENTS_ACTIFS: RecrutementActif[] = [
  {
    offer_id: 'rec-1',
...
export const RECRUTEMENTS_ARCHIVES: RecrutementArchive[] = [
  {
    offer_id: 'arch-1',
  ...
  },
  {
    ...
    type_contrat: 'TITULAIRE_CONTRACTUEL',
    kind_contrat: null,
    date_publication: daysAgo(100),
    derniere_activite: daysAgo(1),
    finalise: true,
