...
export interface components {
    schemas: {
        ...
        DocumentListe: {
            /** Format: uuid */
            document_id: string;
            type_document: components["schemas"]["TypeDocumentEnum"];
            nom_original: string;
            content_type: string;
            taille: number;
            /** Format: uuid */
         ...
         * @enum {string}
         */
        TypeDocumentEnum: "cv" | "lettre_motivation" | "piece_justificative" | "autre";
