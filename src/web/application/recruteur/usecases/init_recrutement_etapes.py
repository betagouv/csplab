...
class InitRecrutementEtapesUsecase(
    ...
    def execute(
        ...
        processus = ProcessusRecrutement(
            schemas=tuple(etape.schema for etape in organisme_recruteur.etapes)  # type: ignore[union-attr]
        )
        recrutement.reinitialiser_processus_recrutement(processus=processus)
