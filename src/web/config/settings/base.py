...
env = environ.Env(
    WEB_ALLOWED_HOSTS=(list, ["localhost"]),
    WEB_LOG_LEVEL=(str, "INFO"),
    WEB_CSRF_TRUSTED_ORIGINS=(list, []),
    WEB_SENTRY_DSN=(str, ""),
    WEB_SENTRY_TRACES_SAMPLE_RATE=(float, 0.0),
    WEB_SENTRY_PROFILES_SAMPLE_RATE=(float, 0.0),
    WEB_PISTE_OAUTH_BASE_URL=(str, "https://fake-piste-oauth.example.com"),
    WEB_INGRES_BASE_URL=(str, "https://fake-ingres-api.example.com/path"),
    WEB_INGRES_CLIENT_ID=(str, "fake-client-id"),
    WEB_INGRES_CLIENT_SECRET=(str, "fake-client-secret"),
    WEB_EMBEDDING_DIMENSION=(int, 1024),
    WEB_ALBERT_API_BASE_URL=(str, "https://albert.api.etalab.gouv.fr"),
    WEB_ALBERT_API_KEY=(str, "albert-api-key"),
    WEB_ALBERT_MODEL=(str, "openweight-large"),
    WEB_ALBERT_OCR_DPI=(int, 200),
...
LOGOUT_REDIRECT_URL = "identite:login"
...
CONVERSATION_OBJET_MAX_LENGTH = 255
CONVERSATION_LAST_MESSAGE_CONTENT_MAX_LENGTH = 300
MESSAGE_CONTENT_MAX_LENGTH = 10_000
MESSAGE_MAX_DOCUMENTS = 5
MESSAGE_DOCUMENT_MAX_SIZE_MB = 5
