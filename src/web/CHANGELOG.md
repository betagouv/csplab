...
- ♻️(web) make test containers independent ([#457](https://github.com/betagouv/csplab/pull/457))
...
- ♻️(web) homogenise tests and refactoring factories and fixtures ([#467](https://github.com/betagouv/csplab/pull/467))
...
- 🐛(web:candidate) reflect active filters in UI on page load ([#380](https://github.com/betagouv/csplab/pull/380))
...
- ✨(web:domain) load metiers data ([#397](https://github.com/betagouv/csplab/pull/397))
- ✨(web-ingestion) clean metiers ([#398](https://github.com/betagouv/csplab/pull/398))
- ✨(web-ingestion) add task for clean metiers ([#414](https://github.com/betagouv/csplab/pull/414))
...
- ♻️(web:ingestion) use async http client ([#389](https://github.com/betagouv/csplab/pull/389))
...
- 🤸(web:candidate) add live region to announce results to screen readers ([#353](https://github.com/betagouv/csplab/pull/353))
...
- ✨(web:candidate) add deep filters to cv_flow view ([#357](https://github.com/betagouv/csplab/pull/357))
- ✨(ingestion) map categories to offers ([#362](https://github.com/betagouv/csplab/pull/362))
- ✨(web:candidate) add Matomo analytics for candidate journey ([#358](https://github.com/betagouv/csplab/pull/358))
...
- 🐛(web:candidate) delete max tokens contraints for experimented cv ([#341](https://github.com/betagouv/csplab/pull/341))
- 🐛(web:candidate) fix toast alert positioning and close button ([#354](https://github.com/betagouv/csplab/pull/354))
- 💚(web) fix ci qdrant ([#356](https://github.com/betagouv/csplab/pull/356))
...
- 🤸(web) add skip links for accessibility ([#275](https://github.com/betagouv/csplab/pull/275))
- ✨(candidate) implement filter fieldset tooltips ([#276](https://github.com/betagouv/csplab/pull/276))
- 🤸(web:candidate) add live region to processing page polling and respect reduced motion preference ([#310](https://github.com/betagouv/csplab/pull/310))
...
- ✨(web) qdrant implementation for vector db ([#316](https://github.com/betagouv/csplab/pull/316))
...
- ✨(web) implementation of soveraign ocr ([#332](https://github.com/betagouv/csplab/pull/332))

### <!-- 2 --> Modified

- 🔧(web:candidate) improve meta tags ([#308](https://github.com/betagouv/csplab/pull/308))
- 🤸(candidate) remove redundant main role ([#309](https://github.com/betagouv/csplab/pull/309))
- 🤸(web:candidate) add a11y sr-only hints on result cards and drawer ([#311](https://github.com/betagouv/csplab/pull/311))
...
- 🤸(web:candidate) hide drag-drop text from AT in dropzone ([#314](https://github.com/betagouv/csplab/pull/314))
...
- ✨(web:candidate) integrate tally form in no results scenario for user feedback ([#245](https://github.com/betagouv/csplab/pull/245))
...
- ✨(web) add field in admin raw documents for better data wrangling ([#285](https://github.com/betagouv/csplab/pull/285))

### <!-- 2 --> Modified

- ♻️(web:candidate) update results page styles and filtering logic ([#196](https://github.com/betagouv/csplab/pull/196))
...
- 🔒️(web) fix CSP nonces on all script tags ([#265](https://github.com/betagouv/csplab/pull/265))
...
- ♻️(web) simplify config for envs ([#215](https://github.com/betagouv/csplab/pull/215))
...
- ✨(web:ingestion) offers ingestion - load documents - use case implementation ([#120](https://github.com/betagouv/csplab/pull/120))
- ✨(web:candidate) add initialize cv_metadatas usecase
...
- ✨(web:candidate) instanciate process_uploaded_cv_usecase in CVUploadView ([#161](https://github.com/betagouv/csplab/pull/161))
...
- 💄(web:candidate) add CSP images required for next integration tasks ([#179](https://github.com/betagouv/csplab/pull/179))
- ✨(test:web) update test command to accept additional arguments (allows filtering) ([#178](https://github.com/betagouv/csplab/pull/178))

### <!-- 2 --> Modified

- ✨(web:ingestion) let clean_documents command accept OFFERS document type ([#152](https://github.com/betagouv/csplab/pull/152))
- ✨(web:candidate) update process uploaded cv usecase ([#160](https://github.com/betagouv/csplab/pull/160))
- ✨(web:candidate) add polling in match cv to opportunities ([#163](https://github.com/betagouv/csplab/pull/163))
...
- 💄 (web:candidate) update global partials styles ([#182](https://github.com/betagouv/csplab/pull/182))
- 💄(web:candidate) update homepage template and styles ([#180](https://github.com/betagouv/csplab/pull/180))

### <!-- 4 --> Fixed

- 🐛(web) fix config web with django 6 ([#151](https://github.com/betagouv/csplab/pull/151))
- 🐛(web:ingestion) fix localisation and reference cleaner ([#154](https://github.com/betagouv/csplab/pull/154))
...
- ✨(web:ingestion) define entities and value objects for offers
- 🔧(project) share vscode config ([#55](https://github.com/betagouv/csplab/pull/55))
- ✨ (web:candidate) add openai implementation for cv ocr ([#46](https://github.com/betagouv/csplab/pull/46))
- (project) add djLint for Django template linting and formatting ([#101](https://github.com/betagouv/csplab/pull/101))
- 🔧(web) configure Sass tooling ([#100](https://github.com/betagouv/csplab/pull/100))
- ✨(web:ingestion) add offer repository ([#103](https://github.com/betagouv/csplab/pull/103))
- Integrate candidate CV upload page ([#53](https://github.com/betagouv/csplab/pull/53))
- ✨(web:candidate) integrate minimal CV processing page ([#102](https://github.com/betagouv/csplab/pull/102))
- (web) Add talentsoft front office client to collect offers ([#95](https://github.com/betagouv/csplab/pull/95))
...
- ✨(web:ingestion) update offer entity and value objects ([#128](https://github.com/betagouv/csplab/pull/128))
- ♻️(web:ingestion) refactor clean tests ([#130](https://github.com/betagouv/csplab/pull/130))

### <!-- 3 --> Removed

- 🔧(web:candidate) remove redundant search path from candidate URLs ([#92](https://github.com/betagouv/csplab/pull/92))
...
- ✨(web:ingestion) set-up ingestion and load CORPS documents
- 🔧(web) add CSRF_TRUSTED_ORIGINS necessary for deployment on https ([#15](https://github.com/betagouv/csplab/pull/15))
- ✨(web:ingestion) add custom django commands to launch usecases
- ✨(web:candidate) add retrieve corps usecase
- ✨(web:candidate) add template for semantic search
- ✨(web:ingestion) ingest concours from greco csv
- ✨(web:candidate) add process cv usecase
- ✨(web:candidate) add match cv to opportunities usecase ([#31](https://github.com/betagouv/csplab/pull/31))
...
- 🔧(tooling) use N-1 processors to launch web tests suite ([#83](https://github.com/betagouv/csplab/pull/83))

### <!-- 2 --> Modified

- 🐛(web:candidate) fix template tags ([#26](https://github.com/betagouv/csplab/pull/26))
- 🐛(web) fix concurrency pb caused by container singletons ([#29](https://github.com/betagouv/csplab/pull/29))
- 📝(tooling) rendre possible l'utilisation des apps python (web & notebook) hors docker ([#35](https://github.com/betagouv/csplab/pull/35))
- 🏗️(tooling) PR template & fixup message ([#42](https://github.com/betagouv/csplab/pull/42))
- 🎨(backend) reorganise web codebase ([#44](https://github.com/betagouv/csplab/pull/44))
- ✨(web:candidate) home page integration ([#37](https://github.com/betagouv/csplab/pull/37))
...
- 🔧(web) fix coverage computation ([#79](https://github.com/betagouv/csplab/pull/79))
